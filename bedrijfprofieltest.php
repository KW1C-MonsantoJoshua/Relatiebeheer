                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <div class="tab-content">
                                        ...
                                        <!-- Change Password Tab -->
                                        <div class="tab-pane" id="general" role="tabpanel" aria-labelledby="change-password-tab">
                                            <form novalidate>
                                            ...
                                            <form novalidate>
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input id="phone" type="text" class="form-control" required placeholder="Phone number" value="(+656) 254 2568">
                                                        </div>
                                                    </div>
                                                    <div class="col-12 form-group">
                                            ...
                                            <form novalidate>
                                                <div class="row">
                                                    <div class="col-12 form-group">
                                                        ...
                                                        <input id="twitter" type="text" class="form-control" placeholder="Add link" value="https://www.twitter.com">
                                                    </div>
                                                    <div class="col-12 form-group">
                                                    ...
                                                    <div class="col-12 form-group">
                                                        ...
                                                        <input id="linkedin" type="text" class="form-control" placeholder="Add link" value="https://www.linkedin.com">
                                                    </div>
                                                    <div class="col-12 form-group">
