                ...
                <div class="form-group">
                    <div class="row5">
                        <div class="comment5 mt-4 text-justify float-left" style="width: 100%;"> <img src="uploads/<?= $RowNoteGebruiker['image_url'] ?>" alt="" class="rounded-circle" width="40" height="40">
                            ...
                            <div class="kip1">
                                <span style="margin-right: 10px; font-size: 15px;"><b><?php echo $RowNote["keuze"]; ?></b></span>
                            <span style="font-size: 15px;"><?php echo $creation_time = date('d-m-Y h:i', strtotime($RowNote['created_at'])); ?></span>
                            </div>
    ...
    <div class="modal fade text-left" id="largechicken1<?= $RowNote["id"] ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel35" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form method="post" action="bedrijf_profiel.php?custof=<?=$_GET["custof"]?>&membof=<?=$_GET["membof"]?>&u=1">
                    <div class="modal-body">
